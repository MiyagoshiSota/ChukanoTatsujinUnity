...
public class EasyCreateNotes : MonoBehaviour
{
    ...
    int[] selectData = new int[]{0,6,4,0,6,6,6,4,4,4,4,2,6,6,6,4,4,4,0,2,6,6,6,4,4,4,2,6,0,6,6,6,4,4,2,6,0,6,4,4,4,2,6,0,6,4,4,4,4,0,4,6,6,6,6,4,4,4,2,6,6,0,4,2,4,4,5,4,0,4,2,6,3,4,4,0,4,6,6,4,4,2,6,6,6,4,4,6,0,6,6,4,4,2,6,0,6,6,6,4,2,6,0,6,4};
    ...
    public void Onpu()//ノーツ生成
    {
        ...
        Debug.Log(PlayerPrefs.GetInt("selectEasy"));
        switch (select)
        {
            case 0://condimentRed

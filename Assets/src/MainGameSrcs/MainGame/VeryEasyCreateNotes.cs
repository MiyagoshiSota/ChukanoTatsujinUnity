...
public class VeryEasyCreateNotes : MonoBehaviour
{
    ...
    int[] noteOrder = new int[]{0 ,0, 6, 6, 5, 4, 4, 0, 6, 6, 4, 4, 4, 3, 0, 0, 6, 6, 4, 4, 4, 0, 0, 0, 6, 6, 6, 4 ,4 ,4 ,0 ,6, 0, 6, 4, 4, 4, 4, 0, 0, 6, 6, 6, 4, 4, 4, 4, 4, 4, 6};
    string difficulty;
